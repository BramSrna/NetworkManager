...
class TestNetworkInformationPropagation(NetworkNodeTestClass):
    def test_all_nodes_in_the_network_receive_a_sent_message_when_naive_propagation_is_used_in_double_layer_network(self):
        test_network_node_1 = self.create_network_node(additional_config_dict={"propagation_strategy": "NaivePropagation"})
        test_network_node_2 = self.create_network_node(additional_config_dict={"propagation_strategy": "NaivePropagation"})
        test_network_node_3 = self.create_network_node(additional_config_dict={"propagation_strategy": "NaivePropagation"})
    ...
    def test_all_nodes_in_the_network_receive_a_sent_message_when_naive_propagation_is_used_in_multi_layer_network(self):
        ...
        test_network_node_2 = self.create_network_node(additional_config_dict={"propagation_strategy": "NaivePropagation"})
        test_network_node_3 = self.create_network_node(additional_config_dict={"propagation_strategy": "NaivePropagation"})
        test_network_node_4 = self.create_network_node(additional_config_dict={"propagation_strategy": "NaivePropagation"})
        test_network_node_5 = self.create_network_node(additional_config_dict={"propagation_strategy": "NaivePropagation"})
        test_network_node_6 = self.create_network_node(additional_config_dict={"propagation_strategy": "NaivePropagation"})
        test_network_node_7 = self.create_network_node(additional_config_dict={"propagation_strategy": "NaivePropagation"})
